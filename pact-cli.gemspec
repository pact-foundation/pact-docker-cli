...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "json", "~>2.19" # must match native lib install in the Dockerfile
  spec.add_dependency "bigdecimal", "~>4.1" # must match native lib install in the Dockerfile
